...
describe('ScanResultComponent', () => {
    ...
    it('should filter by indicator\'s name without sorting', (inject([HttpTestingController],
        (httpMock: HttpTestingController) => {
            const expectedResult = [
                {sort_id: 1, indicator: { id: 1, level: 'IMPACT', color: '', description: '', name: 'search', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''} },
                {sort_id: 3, indicator: { id: 3, level: 'OUTPUT', color: '', description: '', name: 'Search stuff', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''} },
                {sort_id: 4, indicator: { id: 4, level: 'OUTCOME', color: '', description: '', name: 'stuff SEARCH', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''} }
            ];
            component.listOfData = [
                {sort_id: 1, indicator: { id: 1, level: 'IMPACT', color: '', description: '', name: 'search', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''}},
                {sort_id: 2, indicator: { id: 2, level: 'IMPACT', color: '', description: '', name: 'not this', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''}},
                {sort_id: 3, indicator: { id: 3, level: 'OUTPUT', color: '', description: '', name: 'Search stuff', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''}},
                {sort_id: 4, indicator: { id: 4, level: 'OUTCOME', color: '', description: '', name: 'stuff SEARCH', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''}},
                {sort_id: 5, indicator: { id: 5, level: 'OTHER_OUTCOMES', color: '', description: '', name: 'or this', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 0, keys: [], var: ''}},
            ];
    ...
    it('should adjust keyword frequency slider range', (inject([HttpTestingController], (httpMock: HttpTestingController) => {
        const data = {dataResponse: [
            { id: 1, level: '', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 2, keys: [], var: '' },
            { id: 2, level: '', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 1, keys: [], var: '' },
            { id: 3, level: '', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 5, keys: [], var: '' },
            { id: 4, level: '', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 3, keys: [], var: '' }
        ]};
    ...
    it('should update the display data', (inject([HttpTestingController], (httpMock: HttpTestingController) => {
        const data = [
            {sort_id: 1, indicator: { id: 1, level: 'IMPACT', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 2, keys: [], var: ''} },
            {sort_id: 2, indicator: { id: 2, level: 'IMPACT', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 1, keys: [], var: ''} },
            {sort_id: 3, indicator: { id: 3, level: 'IMPACT', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 5, keys: [], var: ''} },
            {sort_id: 4, indicator: { id: 4, level: 'IMPACT', color: '', description: '', name: '', themes: '', source: null, disaggregation: false, crsCode: null, sdgCode: null, numTimes: 3, keys: [], var: ''} }
        ];
